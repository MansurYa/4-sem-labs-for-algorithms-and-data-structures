...
def main():
    ...
    # graph = create_graph(num_nodes=4, num_edges=8, canvas_width=678, canvas_height=395)
    # graph = create_graph(num_nodes=100, num_edges=6000, canvas_width=678, canvas_height=395)
    graph = create_graph(num_nodes=200, num_edges=39000, canvas_width=678, canvas_height=395)
    # graph = Graph()
