    ...
    def start_algorithm(self):
        ...
        if self.modification_var.get():
            ...
            for start_node in self.graph.nodes:
                ...
                result_graph, total_weight, result_mes, path_str = dfs_hamiltonian_cycle(
                    self.graph,
            ...
            self.graph.display()
            self.answer_graph, answer_path_len, result_mes, path_str = dfs_hamiltonian_cycle(self.graph)
